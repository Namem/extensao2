...
Federal de Mato Grosso (IFMT), Cuiabá, sem financiamento externo dedicado.
A Tabela~\ref{tab:recursos} sumariza os recursos de \textit{hardware} e
\textit{software} empregados.
...
(\textit{Transport Layer Security}) ao \textit{broker} HiveMQ Cloud. A imagem e as coordenadas GPS nunca saem do dispositivo, garantindo a privacidade dos dados agrícolas e operacionais da propriedade rural por design. Validado com \textit{benchmark} de
...
experimentos, análises e conclusões são de autoria e responsabilidade exclusivas
do autor.
